    ...
    return (
        <>
            ...
            <div className="card-container">
                ...
                <TechCard list={["Flutter", "ReactJS", "AngularJS"]} logo={flutterLogo} variant="Frontend" text="Developed more than 20 applications till date. 4 of them are published on Play Store" />
